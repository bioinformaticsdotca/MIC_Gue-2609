...
example, you may be looking for a function to compute standard deviation. You can do a fuzzy search to help
...
-   To apply data, geometry and aesthetic layers to a ggplot
    plot.
...
```{r blank-ggplot, message=FALSE, warning = FALSE}
library("ggplot2")
str(penguins)
```
